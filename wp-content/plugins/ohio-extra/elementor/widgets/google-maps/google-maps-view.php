    ...
    <?php if ( !$ohio_api_key ) : ?>
        <div class="clb-blank-note">
            ...
            <div class="clb-blank-note-inner">
                <?php echo esc_html( 'Please', 'ohio-extra' ); ?> <a target="_blank" href="<?php echo get_site_url(); ?>/wp-admin/admin.php?page=theme-general-other"><b><?php echo esc_html( 'enter your API key' ); ?></b></a> <?php echo esc_html( 'to enable Google Maps.', 'ohio-extra' ); ?></a>
