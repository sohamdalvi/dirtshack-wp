<div class="ohio-widget pricing-table <?php echo $this->getWrapperClasses(); ?>" <?php if ( $settings['tilt_effect'] ) { echo esc_attr( $tilt_attrs ); } ?>>
    ...
    <div class="pricing-table-price">
    	...
    	<?php if ( !empty( $settings['old_price'] )  ) : ?>
	    	...
	    	<?php if ( !empty( $settings['currency'] )  ) : ?>
				<s class="old-price"><?php echo $settings['currency'] . $settings['old_price']; ?></s>
			<?php else: ?>
				<s class="old-price"><?php echo $settings['old_price']; ?></s>
			<?php endif; ?>
	...
	<?php if ( $settings['table_button_position'] == 'top' && !empty( $settings['use_link'] ) && !empty( $settings['button_link']['url'] ) ) : ?>
		<div class="pricing-table-button-holder">
	...
	<?php if ( $settings['table_button_position'] == 'default' && !empty( $settings['use_link'] ) && !empty( $settings['button_link']['url'] ) ) : ?>
		<a class="button <?php echo esc_attr( $this->getButtonClasses() ); ?>" 
			<?php echo $this->getLinkAttributesString( $settings['button_link'] ); ?>>
