<div class="ohio-widget team-member banner card <?php echo $this->getWrapperClasses(); ?>">
    <div class="image-holder" <?php if ( $settings['tilt_effect'] ) { echo esc_attr( $tilt_attrs ); } ?>>
        ...
        <?php if ( !empty( $settings['use_link'] ) && !empty( $settings['team_member_link']['url'] ) ) : ?>
            <a class="team-member-link" data-cursor-class="cursor-link" aria-label="<?php echo esc_attr( $settings['team_member_link'] ); ?>" <?php echo $this->getLinkAttributesString( $settings['team_member_link'] ); ?>>
        <?php endif; ?>
                ...
                <?php if ( !empty( $settings['social_networks'] ) ) : ?>
                    <div class="social-networks -outlined -small">
                        <?php foreach ( $settings['social_networks'] as $item ) : ?>
                            <a href="<?php echo $item['list_link']; ?>" target="_blank" rel="nofollow" aria-label="<?php echo esc_attr( $item['list_network'] ); ?>" class="network -unlink <?php echo esc_attr( $item['list_network'] ); ?>">
