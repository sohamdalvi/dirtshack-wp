...
<div class="ohio-widget portfolio-onepage-slider slider autoheight -slider-fs -slider-vertical clb-slider-scroll-bar <?php echo $this->getWrapperClasses(); ?>" data-fullscreen-slider="true" data-options='<?php echo $onepage_json; ?>'>
