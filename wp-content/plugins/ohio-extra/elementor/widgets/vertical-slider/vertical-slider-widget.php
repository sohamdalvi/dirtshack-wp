...
class Ohio_Elementor_Vertical_Slider_Widget extends Ohio_Elementor_Widget_Base {
    ...
    protected function render()
    {
        ...
        if ( $settings['pagination_type'] == 'boxed' ) {
            $this->addWrapperClass( '-with-boxed-pagination' );
        }
    ...
    public function getSliderJson()
    {
        ...
        if ( !empty( $settings['pagination_show'] ) ) {
            if ( $settings['pagination_type'] == 'bullets' ) {
                $obj['dots'] = true;
            } elseif ( $settings['pagination_type'] == 'default' || $settings['pagination_type'] == 'boxed' ) {
                $obj['pagination'] = true;
            }
        }
