...
class Ohio_Elementor_Accordion_Horizontal_Widget extends Ohio_Elementor_Widget_Base {
    ...
    protected function register_controls()
    {
        $this->start_controls_section(
            'title_section',
            [
                'label' => __( 'Horizontal Accordion', 'ohio-extra' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'before',
                'selectors' => [
                    'body:not(.dark-scheme) {{WRAPPER}} .horizontal-accordion-item' => 'background-color: {{VALUE}};',
                ]
            ]
        );
        ...
        $this->add_control(
            'tabs_active_color',
            [
                'label' => __( 'Tabs background (Hover)', 'ohio-extra' ),
                'type' =>  \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    'body:not(.dark-scheme) {{WRAPPER}} .horizontal-accordion-item:not(.active):hover' => 'background-color: {{VALUE}};',
                ]
            ]
        );
