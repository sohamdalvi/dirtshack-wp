...
vc_lean_map( 'ohio_accordion_inner', 'ohio_accordion_inner_sc_map' );

function ohio_accordion_inner_sc_map() {
	return array(
		'name' => __( 'Tab', 'ohio-extra' ),
		'description' => __( 'Ohio accordion tab', 'ohio-extra' ),
		'base' => 'ohio_accordion_inner',
		...
		'params' => array(
			...
			array(
				...
				'group' => __( 'General', 'ohio-extra' ),
				'heading' => __( 'Is Active?', 'ohio-extra' ),
...
if ( class_exists( 'VcShortcodeAutoloader' ) ) {
	...
	class WPBakeryShortCode_Ohio_Accordion_Inner extends WPBakeryShortCode_VC_Tta_Accordion {
