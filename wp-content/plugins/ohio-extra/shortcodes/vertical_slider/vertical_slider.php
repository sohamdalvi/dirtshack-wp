...
function ohio_vertical_slider_func( $atts, $content = '' ) {
	...
	$pagination_type = isset( $pagination_type ) ? OhioExtraFilter::string( $pagination_type, 'string', 'default' ) : 'default';
	...
	if ( $pagination_type == 'boxed' ) {
		$wrapper_classes .= ' -with-boxed-pagination';
	}
	...
	if ( $pagination_show ) {
		...
		} elseif ( $pagination_type == 'default' || $pagination_type == 'boxed' ) {
