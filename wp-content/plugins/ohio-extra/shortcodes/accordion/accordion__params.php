...
vc_lean_map( 'ohio_accordion', 'ohio_accordion_sc_map' );

function ohio_accordion_sc_map() {
	return array(
		'name' => __( 'Accordion', 'ohio-extra' ),
		'description' => __( 'Sections of related content', 'ohio-extra' ),
		'base' => 'ohio_accordion',
		'category' => __( 'Ohio', 'ohio-extra' ),
		'icon' => OHIO_EXTRA_DIR_URL . 'assets/images/shortcodes/accordion_icon.svg',
		'is_container' => true,
		'show_settings_on_create' => false,
		'as_parent' => array(
			'only' => 'ohio_accordion_inner',
		),
		'js_view' => 'VcOhioBackendTtaAccordionView',
		'custom_markup' => '
		...
		',
		'default_content' => '[ohio_accordion_inner title="' . sprintf( '%s %d', esc_html__( 'Section', 'ohio-extra' ), 1 ) . '"][/ohio_accordion_inner][ohio_accordion_inner title="' . sprintf( '%s %d', esc_html__( 'Section', 'ohio-extra' ), 2 ) . '"][/ohio_accordion_inner]',
		'params' => array(
			...
			array(
				...
				'value' => array(
					...
					array(
						'icon' => plugin_dir_url( __FILE__ ) . 'images/wpb_params_0221.svg',
						'key' => 'contained',
					...
					array(
						'icon' => plugin_dir_url( __FILE__ ) . 'images/wpb_params_021_1.svg',
						'key' => 'outline',
			...
			array(
				...
				'holder' => 'em',
				'group' => __( 'General', 'ohio-extra' ),
				'heading' => __( 'Tabs Border', 'ohio-extra' ),
			...
			array(
				...
				'param_name' => 'accordion_tabs_title_typo',
			),
			array(
				'type' => 'ohio_typography',
				'group' => __( 'Styles', 'ohio_extra' ),
				'heading' => __( 'Content Typography', 'ohio-extra' ),
				'param_name' => 'accordion_tabs_content_typo'
			),
			array(
				'type' => 'ohio_colorpicker',
				'group' => __( 'Styles', 'ohio-extra' ),
				'heading' => __( 'Tabs Icon Color', 'ohio-extra' ),
...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_Ohio_Accordion extends WPBakeryShortCode {
