...
function ohio_counter_sc_map() {
	return array(
		...
		'description' => __( 'Skills, numbers, or facts', 'ohio-extra' ),
		'base' => 'ohio_counter',
		...
		'params' => array(
			...
			array(
				'type' => 'ohio_check',
				'group' => __( 'General', 'ohio-extra' ),
				'heading' => __( 'Use "+" Symbol?', 'ohio-extra' ),
			...
			array(
				'type' => 'ohio_typography',
				'group' => __( 'Styles', 'ohio-extra' ),
				'heading' => __( '"+" Symbol Typography', 'ohio-extra' ),
			...
			array(
				...
				'param_name' => 'text_before_typo',
			),
			array(
				'type' => 'ohio_typography',
				'group' => __( 'Styles', 'ohio-extra' ),
				'heading' => __( 'Text After Typography', 'ohio-extra' ),
				'param_name' => 'text_after_typo',
			),
			array(
