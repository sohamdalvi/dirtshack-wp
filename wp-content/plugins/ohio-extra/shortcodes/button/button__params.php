...
function ohio_button_sc_map() {
	return array(
		...
		'description' => __( 'Take actions and choices', 'ohio-extra' ),
		'base' => 'ohio_button',
		...
		'params' => array(
			...
			array(
				'type' => 'ohio_check',
				'group' => __( 'General', 'ohio-extra' ),
				'heading' => __( 'Use Primary Color?', 'ohio-extra' ),
			...
			array(
				'type' => 'ohio_colorpicker',
				'group' => __( 'Styles', 'ohio-extra' ),
				'heading' => __( 'Fill Color (Hover)', 'ohio-extra' ),
			...
			array(
				'type' => 'ohio_colorpicker',
				'group' => __( 'Styles', 'ohio-extra' ),
				'heading' => __( 'Border Color (Hover)', 'ohio-extra' ),
