...
/**
* WPBakery Page Builder Ohio Carousel Inner shortcode params
*/

vc_lean_map( 'ohio_carousel_inner', 'ohio_carousel_inner_sc_map' );

function ohio_carousel_inner_sc_map() {
	return array(
		'name' => __( 'Section', 'ohio-extra' ),
		'description' => __( 'Carousel section', 'ohio-extra' ),
		'base' => 'ohio_carousel_inner',
		...
		'custom_markup' => '
			<div class="vc_tta-panel-heading">
				<h4 class="vc_tta-panel-title vc_tta-controls-icon-position-left"><a href="javascript:;" data-vc-target="[data-model-id=\'{{ model_id }}\']" data-vc-accordion data-vc-container=".wpb_ohio_carousel"><span class="vc_tta-title-text">{{ section_title }}</span><i class="vc_tta-controls-icon vc_tta-controls-icon-plus"></i></a></h4>
			</div>
		...
		'params' => array(
			...
			array(
				...
				'group' => __( 'General', 'ohio-extra' ),
				'heading' => __( 'Section ID', 'ohio-extra' ),
				'description' => __( 'Make sure the ID is unique and not used elsewhere on the page. This field allows A-z 0-9 & underscore chars without spaces.', 'ohio-extra' ),
			),
...
if ( class_exists( 'VcShortcodeAutoloader' ) ) {
	...
	class WPBakeryShortCode_Ohio_Carousel_Inner extends WPBakeryShortCode_VC_Tta_Accordion {
