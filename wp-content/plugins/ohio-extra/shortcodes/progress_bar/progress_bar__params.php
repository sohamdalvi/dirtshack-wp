...
function ohio_progress_bar_sc_map() {
	return array(
		'name' => __( 'Linear Progress', 'ohio-extra' ),
		'description' => __( 'Linear progress indicator', 'ohio-extra' ),
		...
		'params' => array(
			...
			array(
				'type' => 'ohio_check',
				'group' => __( 'General', 'ohio-extra' ),
				'heading' => __( 'Show Max Value Tooltip?', 'ohio-extra' ),
			...
			array(
				...
				'holder' => 'em',
				'group' => __( 'General', 'ohio-extra' ),
				'heading' => __( 'Track Border', 'ohio-extra' ),
			...
			array(
				...
				'holder' => 'em',
				'group' => __( 'General', 'ohio-extra' ),
				'heading' => __( 'Track Corners', 'ohio-extra' ),
			...
			array(
				'type' => 'ohio_colorpicker',
				'group' => __( 'Styles', 'ohio-extra' ),
				'heading' => __( 'Track Border Color', 'ohio-extra' ),
