...
$portfolio_classes = ['vc_row', 'portfolio-grid', 'ohio-masonry', $projects_layout_item];
...
<div class="page-container bottom-offset<?php echo esc_attr( $page_container_class ); ?>">
	...
	<div id="primary" class="<?php echo implode( ' ', $sidebar_page_classes ); ?>">
		<main id="main" class="site-main">
			<div class="<?php echo implode( ' ', $portfolio_classes ); ?>" data-lazy-container="posts">
				<?php
				$_post_i = 0;
				while ( have_posts() ) : the_post();
					...
					echo '<div class="' . esc_attr( $col_class ) . ' masonry-block grid-item" ' . esc_attr( $_anim_attrs ) . ' data-lazy-item="" data-lazy-scope="posts">';
