...
$show_filters = OhioOptions::get( 'woocommerce_show_filters', true );
$show_sort_by = OhioOptions::get( 'woocommerce_show_sort_by', true );
...
<div class="page-container bottom-offset<?php echo esc_attr( $page_container_class ); ?>">
    ...
    <?php if ( $show_filters || $show_sort_by ) : ?>
    ...
    <?php endif; ?>
            ...
            <?php if ( $show_filters ): ?>
                ...
                <?php get_template_part( 'woocommerce/filter-slide-in-panel' ); ?>
            ...
            <?php if ( $show_sort_by ): ?>
                ...
                <div class="ordering-filters -flex -flex-align-center<?php if ( ! $show_filters ) { echo esc_attr(' -flex-row-reverse'); } ?>">
