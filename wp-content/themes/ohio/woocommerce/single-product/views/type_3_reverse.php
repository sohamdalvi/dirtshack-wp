...
<div class="page-container sticky-gallery classic-gallery<?php echo esc_attr( $wrap_container_class ); ?>">
    ...
    <div class="vc_row">
        ...
        <div class="vc_col-lg-8 vc_col-md-6 vc_col-sm-12 woo-product-image<?php if ( $featured_video ) { echo esc_attr(' -with-featured-video'); } ?> <?php echo $image_zoom ? esc_attr('with-zoom') : '' ?>">
