...
if ( $show_category ) {
	...
	// Product categories moved from /single-product/meta.php
	echo wc_get_product_category_list( $product->get_id(), ', ', '<span class="posted_in categories">' . _n( '', '', count( $product->get_category_ids() ), 'ohio' ) . ' ', '</span>' );
}
