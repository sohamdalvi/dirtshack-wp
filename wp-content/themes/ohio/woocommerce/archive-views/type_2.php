...
<div class="product-item-thumbnail">
	...
	<?php if ( function_exists( 'YITH_WCWL_Wishlists' ) ) : ?>

		<div class="button-favorites -fade-down">

			<?php echo do_shortcode( '[yith_wcwl_add_to_wishlist]' ); ?>

			<a href="/?add_to_wishlist=<?php echo esc_attr( $product_id ); ?>" data-product-id="<?php echo esc_attr( $product_id ); ?>" aria-label="favorites" class="icon-button -unlink -dm-ignore add_to_wishlist single_add_to_wishlist btn-wishlist<?php if ( $in_wishlist ) { echo esc_attr(' active'); } ?>">
		    	<i class="icon">
