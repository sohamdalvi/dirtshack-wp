...
$color_switcher_mobile_visibility = OhioOptions::get( 'page_dark_mode_switcher_mobile', true );

$extra_classes = '';
if ( $color_switcher_layout == 'simple' ) {
    $extra_classes .= ' -simple';
}
if ( $color_switcher_mobile_visibility ) {
...
<?php if ( $color_switcher_visibility && !$auto_mode ) : ?>
