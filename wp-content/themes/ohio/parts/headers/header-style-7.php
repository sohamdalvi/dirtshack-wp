...
<header id="masthead" class="header header-sidebar header-7<?php echo esc_attr( $header_classes ); ?>"<?php if ( ! $header_fixed ) { echo esc_attr( $header_sticky_attr ); } ?>>
    <div class="header-wrap">
        <div class="header-wrap-inner vertical-inner">
            ...
            <div class="middle-part<?php echo esc_attr( $dynamic_typo_class ); ?>">
