<?php
    ...
    $header_contained_menu = OhioOptions::get( 'page_header_contained_menu', false );
    ...
    if ( $header_contained_menu ) { 
        $header_classes .= ' -with-contained-menu'; 
    }
    if ( $show_subheader ) { 
...
<header id="masthead" class="header header-4<?php echo esc_attr( $header_classes ); ?>"<?php if ( ! $header_fixed ) { echo esc_attr( $header_sticky_attr ); } ?>>
