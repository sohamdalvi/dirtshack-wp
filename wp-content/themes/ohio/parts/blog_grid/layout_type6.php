...
<div class="blog-item card -layout6<?php echo esc_attr( $blog_grid_class ); ?> <?php echo esc_attr( $hover_effect_class ); ?>" <?php echo esc_attr( $anim_attrs ); ?> <?php echo $ohio_post['boxed'] ? esc_attr( $parallax_data ) : ''; ?>>
	<a class="-unlink" href="<?php echo esc_url( $ohio_post['url'] ); ?>" data-cursor-class="cursor-link" aria-label="<?php echo esc_html( $ohio_post['title'] ); ?>">
	...
	<div class="card-details">
		...
		<div class="card-details-item -<?php echo esc_attr( $ohio_post['alignment'] ); ?>">
			<h4 class="heading title">
				...
				<?php endif; ?>
				<a class="-undash -unlink" href="<?php echo esc_url( $ohio_post['url'] ); ?>">
		...
		<div class="card-details-item">
			<?php if ( $read_more_visibility ) : ?>
		        <a class="read-more -unlink" href="<?php echo esc_url( $ohio_post['url'] ); ?>" aria-label="<?php esc_html_e( 'Read More', 'ohio-extra' ); ?>">
