 ...
 *	Mega Menu 
 */
if ( ! defined( 'OHIO_MEGA_MENU_CLASS' ) ) define( 'OHIO_MEGA_MENU_CLASS', 'Ohio_Mega_Menu' );
if ( ! defined( 'OHIO_EDIT_MENU_WALKER_CLASS' ) ) define( 'OHIO_EDIT_MENU_WALKER_CLASS', 'Ohio_Edit_Menu_Walker' );
if ( ! defined( 'OHIO_NAV_MENU_WALKER_CLASS' ) ) define( 'OHIO_NAV_MENU_WALKER_CLASS', 'Ohio_Nav_Menu_Walker' );
...
if ( ! function_exists( 'ohio_mega_menu_walker' ) ) {
	...
	function ohio_mega_menu_walker( $args = '' ) {
		...
		if ( !$args['walker'] ) {
			$class = OHIO_NAV_MENU_WALKER_CLASS;
