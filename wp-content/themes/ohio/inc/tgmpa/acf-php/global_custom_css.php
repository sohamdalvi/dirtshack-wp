    ...
    acf_add_local_field_group( [
        ...
        "fields" => [
            ...
            [
                ...
                "type" => "ohio_code",
                "instructions" => __( 'Add JS code to the header of your site (e.g. Google Analytics). <em>To use jQuery wrap the code into:<br></em> <b>jQuery(function($){ ... });</b>', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "default_value" => "",
                "language" => "javascript"
            ...
            [
                ...
                "type" => "ohio_code",
                "instructions" => __( 'Add JS code to the footer of your site (e.g. Google Analytics). <em>To use jQuery wrap the code into:<br></em> <b>jQuery(function($){ ... });</b>', 'ohio' ),
                "required" => 0,
                "conditional_logic" => 0,
                "default_value" => "",
                "language" => "javascript"
